...
from open_clip_train.eval import run_image_retrieval_evaluation
...
def evaluate(model, data, epoch, args, tb_writer=None, tokenizer=None):
    ...
    if args.retrieval_benchmark_dir and "val" in data:
        if args.val_frequency and (
            (epoch % args.val_frequency) == 0 or epoch == args.epochs
        ):
            retrieval_metrics = run_image_retrieval_evaluation(model, data, epoch, args)
